...
export default function StudentTimetable() {
  ...
  return (
    <PortalLayout role="student" title="My Timetable">
      <div className="flex items-center justify-between mb-24" style={{ flexWrap: 'wrap', gap: 12 }}>
        <div className="flex items-center gap-12">
          <select className="form-select" style={{ width: 150 }}><option>Semester 5</option><option>Semester 4</option></select>
        </div>
        <div className="flex items-center gap-12">
          ...
          <button className="btn btn-secondary ml-8"><Download size={16} />Download</button>
        </div>
      </div>
