...
import { Calendar, Bell, Megaphone, CheckCheck } from 'lucide-react'

const iconMap = {calendar:Calendar,bell:Bell,megaphone:Megaphone}
const tabs = ['All','Timetable Updates','Requests','Announcements']

export default function FacultyNotifications() {
  const [tab, setTab] = useState('All')
  const filtered = tab==='All' ? notifications : notifications.filter(n=>n.cat===tab)
  return (
    <PortalLayout role="faculty" title="Notifications">
